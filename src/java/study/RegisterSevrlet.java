 ...
 * @author PC
 */
@WebServlet(name = "RegisterSevrlet", urlPatterns = {"/RegisterSevrlet"})
public class RegisterSevrlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {//(PrintWriter out = response.getWriter()) {
           ...
           String fname = request.getParameter("ime");
           String lname = request.getParameter("prezime");
           String email = request.getParameter("email");
           String pword = request.getParameter("pword");
           String namePar= request.getParameter("imeRoditelja");
           ...
           //RegisterBean rb = new RegisterBean(fname, lname, email, newPword, myHash);
           RegisterBean rb = new RegisterBean(fname, lname, email, newPword, myHash, namePar, jmbg, mobilni, fiksni);
           rb.setPol(pol);
